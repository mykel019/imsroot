            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12 widgets-wrapper">
                    <div class="x_panel">
                        <form id="form-filters">
                             <div class="form-group">
                                <h4>Subscribers Statistic</h4>
                                <hr>
                                <h5>Filter by Subscriber:</h5>
                                <select class="form-control" name="subscribers_suspend" id="subscribers_suspend">
                   ...
                   <!--  <div class="col-md-12 hint">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci veniam minus quasi explicabo officia expedita repellat molestias vitae iure, aspernatur id magnam provident rerum numquam, architecto fugit dolorem eos ab!</p>
                    </div> -->
                </div>
            </div>
            <br />
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#subscribers_suspend").change(function(){
