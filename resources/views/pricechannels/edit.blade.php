                        ...
                        <div class='x_content'>
                            <form method="POST" action="{{ url('/').'/'.$module.'/update'}}" onsubmit="return false" id="form">
                                            ...
                                            <div class="section-body row">
                                                ...
                                                <div class="col-md-12 row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Price</label>
                                                            <input type='text' name='price' value="{{ $result->price }}" class='numberinput form-control'>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                ...
                                <div class="row" style="text-align: center">
                                    <button class="btn btn-success submit">Update {{ $title }}</button>
                                </div>
                            </form>
...
<script>
    $(document).ready(function(){
        clientId = $("select[name=client_id]").selectize();
        clientId[0].selectize.setValue('{{ $result->client_id }}')

        $("select[name=discount_type_id]").val('{{  $result->discount_type_id}}')
    })
</script>
@endsection