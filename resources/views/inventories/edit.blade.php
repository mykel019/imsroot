                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="page-title">
                        <div class="title_left">
                            <a href="{{ url($module.'/index') }}" class="btn btn-default"><i class="fa fa-long-arrow-left"></i> Return to {{ $title }}</a>
                        </div>

                    </div>
                    <div class='x_content'>
                            <form method="POST" action="{{ url('/').'/'.$module.'/update'}}" id="form">
                                            ...
                                            <div class="section-body">
                                                <div class="row">
                                                        ...
                                                        <div class="form-group {{ $errors->has('category_id') ? ' has-error' : '' }}">
                                                            ...
                                                            <select name='category_id' value="{{ old('category_id') }}"  class='form-control'>
                                                                ...
                                                                <?php foreach ($categories as $key => $value): ?>
                                                                    <?php 
                                                                        $selected = '';
                                                                        if (old('category_id') == $value->id || $result->category_id == $value->id){
                                                                            $selected = 'selected';
                                                                        } 
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
                                                            ...
                                                            <textarea name='description'  class='form-control'>{{ (old('description')) ? old('description') : $result->description }}</textarea>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group {{ $errors->has('code') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='code' value="{{ (old('code')) ? old('code') : $result->code }}"  class='form-control'>
                                                            @if ($errors->has('code'))
                                                            <span class="help-block">
                                                        ...
                                                        <div class="form-group {{ $errors->has('sku') ? ' has-error' : '' }}">
                                                            <label>SKU</label>
                                                            <input type='text' name='sku' value="{{ (old('sku')) ? old('sku') : $result->sku }}"  class='form-control'>
                                                            @if ($errors->has('sku'))
                                                            <span class="help-block">
                                                        ...
                                                        <div class="form-group {{ $errors->has('stock_code') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='stock_code' value="{{ (old('stock_code')) ? old('stock_code') : $result->stock_code }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('supplier_code') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='supplier_code' value="{{ (old('supplier_code')) ? old('supplier_code') : $result->supplier_code }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('barcode') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='barcode' value="{{ (old('barcode')) ? old('barcode') : $result->barcode }}"  class='form-control'>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <div class="form-group {{ $errors->has('unitofmeasure_id') ? ' has-error' : '' }}">
                                                            ...
                                                            <select name='unitofmeasure_id' value="{{ (old('unitofmeasure_id')) ? old('unitofmeasure_id') : $result->unitofmeasure_id }}" class="form-control">
                                                            </select>
                                                        ...
                                                        <div class="form-group {{ $errors->has('qty') ? ' has-error' : '' }}">
                                                            <label>Qty</label>
                                                            <input type='text' name='qty' value="{{ (old('qty')) ? old('qty') : $result->qty }}" readonly  class='form-control'>
                                                            @if ($errors->has('qty'))
                                                            <span class="help-block">
                                                        ...
                                                        <div class="form-group {{ $errors->has('cost') ? ' has-error' : '' }}">
                                                            <label>Cost</label>
                                                            <input type='text' name='cost' value="{{ (old('cost')) ? old('cost') : $result->cost }}"  class='form-control'>
                                                            @if ($errors->has('cost'))
                                                            <span class="help-block">
                                                        ...
                                                        <div class="form-group {{ $errors->has('price_default') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='price_default' value="{{ (old('price_default')) ? old('price_default') : $result->price_default }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('zero_rated') ? ' has-error' : '' }}">
                                                            ...
                                                            <select name='zero_rated' value="{{ (old('zero_rated')) ? old('zero_rated') : $result->zero_rated }}"  class='form-control'>
                                                ...
                                                <div class="row col-md-12">
                                                    <label for="">POS Required Fields</label>
                                                     <input type="text" name="pos_required_fields" value="{{ (old('pos_required_fields')) ? old('pos_required_fields') : $result->pos_required_fields }}" class="form-control">
                                                </div>
...
<script>
    $(document).ready(function(){
        ...
        var cf = JSON.parse('<?=(old("custom_fields")) ? json_encode(old("custom_fields")) : $result->custom_fields  ?>');
