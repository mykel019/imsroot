                                                ...
                                                <div class="section-body row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                                                            <label>Email</label>
                                                            <input type='email' name='email' value="{{  (old('email')) ? old('email') : $result->email }}" class='form-control'>
                                                            @if ($errors->has('email'))
                                                            <span class="help-block">
                                                        ...
                                                        <div class="form-group {{ $errors->has('account_manager') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='account_manager' value="{{  (old('account_manager')) ? old('account_manager') : $result->account_manager }}"  class='form-control'>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='phone' value="{{  (old('phone')) ? old('phone') : $result->phone }}"  class='form-control'>
                                                            @if ($errors->has('phone'))
                                                            <span class="help-block">
                                                        ...
                                                        <div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='fax'  value="{{(old('fax')) ? old('fax') :  $result->fax }}" class='form-control'>
                                                            @if ($errors->has('fax'))
                                                            <span class="help-block">
                                                ...
                                                <div class="section-body row">
                                                    <div class="col-md-6">
                                                        <div class="form-group{{ $errors->has('bill_addr1') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='bill_addr1' value="{{  (old('bill_addr1')) ? old('bill_addr1') : $result->bill_addr1 }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group{{ $errors->has('bill_addr2') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='bill_addr2' value="{{  (old('bill_addr2')) ? old('bill_addr2') : $result->bill_addr2 }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group{{ $errors->has('bill_city') ? ' has-error' : '' }}">
                                                            <label>City</label>
                                                            <input type='text' name='bill_city' value="{{  (old('bill_city')) ? old('bill_city') : $result->bill_city }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group{{ $errors->has('bill_province') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='bill_province' value="{{  (old('bill_province')) ? old('bill_province') : $result->bill_province }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group{{ $errors->has('bill_postal') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='bill_postal' value="{{  (old('bill_postal')) ? old('bill_postal') : $result->bill_postal }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group{{ $errors->has('bill_country') ? ' has-error' : '' }}">
                                                            <label>Country</label>
                                                            <input type='text' name='bill_country' value="{{  (old('bill_country')) ? old('bill_country') : $result->bill_country }}"  class='form-control'>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group {{ $errors->has('ship_addr1') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='ship_addr1' value="{{  (old('ship_addr1')) ? old('ship_addr1') : $result->ship_addr1 }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('ship_addr2') ? ' has-error' : '' }}">
                                                            ...
                                                            <input type='text' name='ship_addr2' value="{{  (old('ship_addr2')) ? old('ship_addr2') : $result->ship_addr2 }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('ship_city') ? ' has-error' : '' }}">
                                                            <label>City</label>
                                                            <input type='text' name='ship_city' value="{{  (old('ship_city')) ? old('ship_city') : $result->ship_city }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('ship_province') ? ' has-error' : '' }}">
                                                            <label>Province / State</label>
                                                            <input type='text' name='ship_province' value="{{  (old('ship_province')) ? old('ship_province') : $result->ship_province }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('ship_postal') ? ' has-error' : '' }}">
                                                            <label>Postal Code / Zip Code</label>
                                                            <input type='text' name='ship_postal' value="{{  (old('ship_postal')) ? old('ship_postal') : $result->ship_postal }}"  class='form-control'>
                                                        ...
                                                        <div class="form-group {{ $errors->has('ship_country') ? ' has-error' : '' }}">
                                                            <label>Country</label>
                                                            <input type='text' name='ship_country' value="{{  (old('ship_country')) ? old('ship_country') : $result->ship_country }}"  class='form-control'>
