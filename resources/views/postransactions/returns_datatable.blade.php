    <table class="table">
        ...
        <tbody>
            ...
            <tr id="<?=$value->id?>">
                ...
                <td><?=ucwords($value->total_tender) ?></td>
                <td><?=ucwords($value->total_due) ?></td>
                <td class="action-buttons">
                     <a href="{{ url('returndetails/index/'.Crypt::encrypt($value->id)) }}" class="btn btn-info btn-xs">View Invoices</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
