                        ...
                        <div class='x_title'>
                            <div class="row">
                                @if($_add == '1' || Auth::User()->position_id == '0')
                                    <a href="#" class="btn btn-app new-dr" style="float:left"> <i class="fa fa-plus"></i> New</a>
                                @else
                                @endif
                ...
                <div class="col-md-3 col-sm-12 col-xs-12 widgets-wrapper">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form onsubmit="return false" id="form-filters">
                                ...
                                <div class="form-group">
                                    <label for="">Delivery Date Range</label>
                                    <div class="row">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <table class="table">
                                <tr>
                                    <td>Not Sent Deliveries:</td>
                                    <td><span class="badge" style="background-color:orange">{{$notsent}}</span></td>
                                </tr>
                                <tr>
                                    <td>Sent Deliveries:</td>
                                    <td><span class="badge" style="background-color:green">{{$sent}}</span></td>
                                </tr>
                                <tr>
                                    <td>Received Deliveries:</td>
                                    <td><span class="badge">{{$total_received}}</span></td>
                                </tr>
                                <tr>
                                    <td>Total Number of Deliveries:</td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click','.new-dr',function(){
            window.location.href = base_url+'/deliveries/create/';
        });
