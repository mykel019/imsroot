        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-12 col-xs-12 widgets-wrapper">
                    <div class="x_panel">
                        <h4>Discount Statistics</h4>
                        <div class="x_content">
                            <table class="table">
                                <tr>
                                    <td style="vertical-align:middle">Total Discounts</td>
                                    <td style="text-align:right"><h4>{{ $total }}</h4></td>
                                </tr>
                                <tr>
                                    <td style="vertical-align:middle">Total Active</td>
                                    <td style="text-align:right"><h4>{{ $active }}</h4></td>
                                </tr>
                                <tr>
                                    <td style="vertical-align:middle">Total Expired</td>
                                    <td style="text-align:right"><h4>{{ $expired }}</h4></td>
                                </tr>
                            </table>
                        </div>
                    </div>
